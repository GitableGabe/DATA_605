...
```
    ...
    Shape of preprocessed images: (13233, 4096)
...
```
    ...
    Number of principal components required to account for 80% of the variability is: 31
...
![png](DATA_605_GCampos_HW1_Q4_files/DATA_605_GCampos_HW1_Q4_14_0.png)
