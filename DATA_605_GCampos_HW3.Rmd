...
- $F-statistic$ of $14.96$ and $p-value \approx 0.0004$ indicates statistical significanc but explains less variability.
- Standard Error $(SE)$ of $10.15$ a relatively good fit with the precision of the estimated regression coefficient (like the slop or intercept).
- Positive coefficient $9.641 \times 10^{-5}$ indicates as healthcare expenditure increases so does life expectancy.
- The plots show no normality with the residuals.
- There are no signs homoscedasticity as the points do not show randomness, a funnel or fan like shape.
- The pattern with these two variable indicates there is no independence.
- The Q-Q plot points deviates significantly indicating Non-Normality, which is supported by the Historgram of the Residuals.
- The relationship between the variables does not seem linear.
...
- $F-statistic$ of $56.09$ and $p-value = 4.61 \times 10^{9}$ indicates greater statistical significance and captures greater proportion of variability.
- Standard Error $(SE)$ of $116,900,000$ can be viewed as a worse fit with the precision of the estimated regression coefficient but is more likely a result of the greater magnitude.
- Positive coefficient $295518$ indicates as healthcare expenditure increases so does life expectancy still, but to a greater magnitude.
- The plots show left skewed results with a more normalized residual.
- There are no signs homoscedasticity as the points do not show randomness, a funnel or fan like shape.
- The pattern with these two variable indicates there is no independence.
- The Q-Q plot points still deviates albeit no as significantly, indicating Normality, which is supported by the Histogram of the Residuals.
- The relationship between the variables does seem more linear when compared to its predecessor, but still non-linear overall.
